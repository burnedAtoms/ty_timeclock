...
export const action = async ({ request }: ActionFunctionArgs) => {
  ...
  if (typeof firstname !== "string" || firstname.length === 0) {
    return json(
      { errors: { firstname: "Firstname is required", surname: null, email: null, password: null } },
      { status: 400 },
    );
  }
  if (typeof surname !== "string" || surname.length === 0) {
    return json(
      { errors: { firstname: null, surname: "Surname is required", email: null, password: null } },
      { status: 400 },
    );
  }
      ...
      <div className="mx-auto w-full max-w-md px-8">
        <Form method="post" className="space-y-6">
          ...
          <div>
            <label 
            htmlFor="surname" 
            className="block text-sm font-medium text-gray-700">Surname Name</label>
            <input 
            type="text" 
            name="surname" 
            required
